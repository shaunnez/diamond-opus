...
SUBSCRIPTION_ID="${SUBSCRIPTION_ID:-29b88434-1746-4a0e-8160-c78dacf6c676}"
RESOURCE_GROUP="diamond-tfstate-rg"
STORAGE_ACCOUNT="diamondtfstateprod"
...
az storage account create \
    --name "diamondtfstateprod" \
    --resource-group "diamond-tfstate-rg" \
    --location "australiaeast" \
    --sku Standard_LRS \
    --kind StorageV2 \
