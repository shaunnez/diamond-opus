...
export const TABLE_COLUMNS: Record<AllowedTable, { name: string; type: string }[]> = {
  diamonds: [
    ...
    { name: 'fluorescence_intensity', type: 'string' },
    { name: 'fancy_color', type: 'string' },
    { name: 'fancy_intensity', type: 'string' },
    { name: 'fancy_overtone', type: 'string' },
    { name: 'ratio', type: 'number' },
    { name: 'lab_grown', type: 'boolean' },
    { name: 'treated', type: 'boolean' },
    { name: 'feed_price', type: 'number' },
    { name: 'diamond_price', type: 'number' },
